...
describe('Crop', () => {
  ...
  test('coordinates', () => {
    expect(fastlyImageUrl(IMAGE_URL, { crop: { type: 'Coord', height: 900, width: 1600, x: 100, y: '50p' } })).toEqual(
      `${IMAGE_URL}?crop=1600,900,x100,y50p`
    )
  })

  test('offset', () => {
    expect(
      fastlyImageUrl(IMAGE_URL, { crop: { type: 'Offset', height: 900, width: 1600, xOffset: '100p', yOffset: '50p' } })
